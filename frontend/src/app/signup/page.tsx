...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        // Prepare data - only include trainer fields if is_trainer is true
        ...
        // Add trainer fields if applicable (will be handled in US 1.2)
    ...
    <div className="signup-container">
      <div className="signup-box">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          {/* Password with Requirements Popup */}
          <div className="form-group">
            ...
            <div className="trainer-fields">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`form-input ${errors.certifications ? 'error' : ''}`}
                  placeholder="e.g., NASM-CPT, ACE, ISSA (comma-separated)"
                />
