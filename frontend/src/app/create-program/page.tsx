...
export default function CreateProgramPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/my-programs?created=${created.id}`);
    } catch (err) {
  ...
  return (
    <div className="create-program-page">
      ...
      <main className="create-program-main">
        <p className="create-program-desc">
          Add a new workout program. You can publish it so users can discover it in Browse Programs.
        </p>
          ...
          <div className="form-group checkbox-group">
            <label className="checkbox-label">
              <input
                ...
                className="form-checkbox"
              />
              Publish immediately (visible in Browse Programs)
            </label>
          </div>
